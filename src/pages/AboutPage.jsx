        ...
        <div className="max-w-6xl mx-auto p-8 space-y-8 bg-[#F4F2F7] pt-28 pb-20">
          <div className="space-y-6">
            ...
            <p className="text-gray-800 leading-relaxed">
              ...
              Ironhack's full-stack web development bootcamp. My goal is to
              create intuitive, efficient, and responsive front-end solutions
              that simplify and enhance everyday life.
            </p>

            <p className="text-gray-800 leading-relaxed">
              I believe great user experience emerges at the intersection of
              functionality, simplicity, and style. My experience as an
              architect in Paraguay taught me to think big-picture first,
              collaborating with clients, teams, and suppliers to harmonize
              diverse needs and perspectives—skills that seamlessly translate to
              UX/UI and web development. Equipped with a Master's in UX/UI from
              ESDI (Barcelona) and a deep desire to solve problems, I'm ready to
              design and implement digital solutions that are not only beautiful
              but also functional and user-centered.
            </p>

            <p className="text-gray-800 leading-relaxed">
              I am now looking for opportunities to utilize and develop my
              current knowledge and experiences, whilst providing customers with
